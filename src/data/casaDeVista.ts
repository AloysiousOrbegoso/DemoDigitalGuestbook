...
export const casaDeVista: GuideContent = {
  property: {
    name: "Casa de Vista",
      ...
      blocks: [
        {
          ...
          items: [
            ...
            { title: "Early or late", detail: "Ask us a day ahead. If the house is free, the answer is yes.", icon: "clock" },
          ],
        },
        {
          type: "map-link",
      ...
      blocks: [
        {
          type: "list",
          items: [
            { title: "Pool", detail: "Saltwater, 1.4 m at the deep end. There's no lifeguard, so kids need an adult poolside.", icon: "pool" },
            { title: "Beach access", detail: "A private path from the back garden. Forty steps to the sand.", icon: "beach" },
            { title: "Aircon", detail: "In every bedroom. Remotes live in the bedside table drawers.", icon: "air-conditioning" },
            { title: "Kayaks", detail: "Two sit-on-top kayaks under the stairs, with life vests. Stay inside the point.", icon: "kayak" },
            { title: "Laundry", detail: "Washer by the outdoor shower. Line-dry on the roof deck; on a sunny day things dry in two hours.", icon: "wash-machine" },
            { title: "Outdoor shower", detail: "For rinsing off sand before you come inside. Hot water takes a minute to arrive.", icon: "droplet" },
            { title: "Parking", detail: "Room for two cars inside the gate. A third fits on the road shoulder.", icon: "car" },
          ],
        },
      ],
    },
      ...
      blocks: [
        {
          type: "list",
          items: [
            { title: "Quiet hours", detail: "10 PM to 7 AM. Sound carries over water, and our neighbors are fishermen who start early.", icon: "moon" },
            { title: "Smoking", detail: "Outside only, on the beach side of the garden. Butts go in the tin can, not the sand.", icon: "smoking-no" },
            { title: "Guests", detail: "Up to 10 people overnight. Day visitors are welcome until 9 PM.", icon: "users" },
            { title: "Celebrations", detail: "Birthdays and small parties are fine. Tell us ahead if you're bringing a sound system.", icon: "confetti" },
            { title: "Pool", detail: "No glass in or near the pool. Plastic cups are in the cabinet by the veranda.", icon: "glass-off" },
            { title: "Damage", detail: "Accidents happen. Tell us early and we'll sort it out together. Deliberate damage is charged at repair cost.", icon: "tool" },
          ],
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          items: [
            { title: "Cooking basics", detail: "Oil, salt, pepper, sugar, soy sauce, vinegar, and garlic.", icon: "basket" },
            { title: "Coffee", detail: "Local barako beans and a French press. The grinder is in the corner cabinet.", icon: "coffee" },
            { title: "Drinking water", detail: "The five-gallon jug on the dispenser. Tap water is fine for cooking, not for drinking.", icon: "bottle" },
          ],
        },
        {
          type: "steps",
      ...
      blocks: [
        {
          ...
          urgent: true,
          methods: [
            { kind: "call", label: "Call 911", value: "911", detail: "National emergency hotline for police, fire, and ambulance" },
            { kind: "call", label: "Call the host emergency line", value: HOST_PHONE, detail: "Any hour, for anything urgent at the house" },
          ],
        },
        {
          type: "map-link",
        ...
        },
        {
          ...
          items: [
            ...
            { title: "Fire extinguishers", detail: "By the front door and next to the stove.", icon: "flame" },
            { title: "Flashlights", detail: "Hallway cabinet, with spare batteries. Brownouts happen in storm season.", icon: "bulb" },
          ],
        },
      ],
    },

    {
      ...
      blocks: [
        ...
        },
        {
          type: "list",
          items: [
            { title: "Pet fee", detail: "₱500 per pet per stay, paid at check-in. It covers the deep clean afterward.", icon: "paw" },
            { title: "Indoors", detail: "Off the beds and sofas, please. There are two washable dog beds in the hallway closet.", icon: "sofa" },
            { title: "On the beach", detail: "Keep dogs leashed on the path and pick up after them. Fishermen dry their nets on the sand.", icon: "dog" },
            { title: "Pool", detail: "Pets stay out of the pool. The outdoor shower is great for rinsing a sandy dog.", icon: "pool" },
            { title: "Alone time", detail: "Please don't leave pets alone in the house for more than a few hours.", icon: "clock" },
          ],
        },
      ],
    },

    {
      ...
      blocks: [
        ...
        },
        {
          type: "list",
          items: [
            { title: "Water", detail: "Short showers, and the outdoor shower for rinsing sand. Towels get changed every three days unless you ask sooner.", icon: "droplet" },
            { title: "Power", detail: "Solar panels cover most of the daytime load. Switch the aircon off when you head out.", icon: "solar-panel" },
            { title: "Reef-safe sunscreen", detail: "The reef off the point is still recovering. Mineral sunscreen only in the water; there's a bottle by the door if you forgot yours.", icon: "sun" },
            { title: "Local sourcing", detail: "Eggs, bread, and coffee come from neighbors and the town market.", icon: "basket" },
            { title: "Less plastic", detail: "Refill your bottles from the water jug. Reusable tote bags hang by the front door for market runs.", icon: "recycle" },
          ],
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          methods: [
            ...
            { kind: "sms", label: "Send a text", value: HOST_PHONE, detail: "Usually answered within the hour" },
            { kind: "email", label: "Email us", value: HOST_EMAIL, detail: "For booking questions and receipts" },
          ],
        },
        {
          type: "text",
