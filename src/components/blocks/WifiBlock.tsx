...
import type { WifiBlockData } from "../../types/guide";
...
type Field = "network" | "password";

export function WifiBlock({ network, password, note }: WifiBlockData) {
  ...
  return (
    <div className="block block-wifi">
      ...
      {failed && <p className="wifi-error">Copying isn't allowed in this browser. Press and hold the password to select it.</p>}
