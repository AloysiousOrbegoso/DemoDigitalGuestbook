...
const SUGGESTIONS = ["wifi", "checkout", "pool", "trash", "hospital"];

interface Props {
  content: GuideContent;
  onSelect: (pageId: string) => void;
  onClose: () => void;
  /** "contained" fills its positioned parent (mobile shell, phone frame); "modal" covers the window. */
  variant?: "contained" | "modal";
}

export function SearchOverlay({ content, onSelect, onClose, variant = "contained" }: Props) {
